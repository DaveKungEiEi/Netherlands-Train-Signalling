# Image credits — Comparison page

Images used on `comparison.html` are selected to avoid repeating the imagery already used on the ERTMS/ETCS page. The website displays attribution in each image caption; this file keeps the full source and licence references in one place.

## Netherlands — Harlingen Haven
- File: **Arriva Stadler 610 op Station Harlingen-Haven.jpg**
- Author: **Roepers**
- Source: https://commons.wikimedia.org/wiki/File:Arriva_Stadler_610_op_Station_Harlingen-Haven.jpg
- Licence: **CC BY-SA 4.0**
- Licence: https://creativecommons.org/licenses/by-sa/4.0/
- Use on site: current Dutch Tranche 1 / Harlingen Haven context.

## Belgium — Infrabel Eurobalises
- File: **Infrabel L202 Eurobalises for signal F-M.4.jpg**
- Author: **M!dgard**
- Source: https://commons.wikimedia.org/wiki/File:Infrabel_L202_Eurobalises_for_signal_F-M.4.jpg
- Licence: **CC0 1.0**
- Licence: https://creativecommons.org/publicdomain/zero/1.0/
- Use on site: physical ETCS / Eurobalise infrastructure in Belgium.

## Germany — ICE 1 ETCS cab
- File: **Führerstand ICE 1 ETCS.jpg**
- Author: **Sese Ingolstadt**
- Source: https://commons.wikimedia.org/wiki/File:F%C3%BChrerstand_ICE_1_ETCS.jpg
- Licence: **CC BY 3.0**
...
- Author: **Onderwijsgek**
- Source: https://commons.wikimedia.org/wiki/File:Monument_treinramp_Harmelen_26052012_07.JPG
- Licence: **CC BY-SA 3.0**
- Licence: https://creativecommons.org/licenses/by-sa/3.0/
- Use on site: historical context for the 1962 Harmelen disaster and subsequent acceleration of ATB deployment.

## Cross-border — Drielandentrein / LIMAX
- File: **RE 18 006 (cropped).jpg** (derived from `RE 18 006.jpg`)
- Author: **Magicman0361**
- Source: https://commons.wikimedia.org/wiki/File:RE_18_006.jpg
- Licence: **CC BY-SA 4.0**
- Licence: https://creativecommons.org/licenses/by-sa/4.0/
